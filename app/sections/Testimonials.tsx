...
export default function Testimonials() {
  return (
    <section
      id="testimonials"
      className="relative py-10 sm:py-14 md:py-20 lg:py-16 xl:py-28 px-4 sm:px-6"
    >
      <div className="max-w-5xl mx-auto">

        {/* Header */}
        <ScrollReveal>
          <div className="text-center mb-6 sm:mb-10 lg:mb-8 xl:mb-12">
            <p className="font-playfair font-bold text-brand-gold text-sm sm:text-base md:text-lg lg:text-base xl:text-xl tracking-[0.15em] uppercase mb-3 lg:mb-3 xl:mb-4">
              Client Testimonials
            </p>
            <h2 className="font-playfair font-bold text-white text-xl sm:text-2xl md:text-3xl lg:text-[28px] xl:text-[40px]" style={{ lineHeight: 1.35 }}>
              Results That Speak
            </h2>
          ...
          {testimonials.map((t, i) => {
            ...
            return (
              <StaggeredReveal
                ...
                direction="up"
                delay={100}
                baseDelay={isTopRow ? 250 : 0}
                threshold={isTopRow ? 0 : 0.3}
                className="flex"
                preserveBackdrop
              >
