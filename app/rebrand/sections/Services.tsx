...
function TierCard({
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3 className="font-playfair font-bold text-white text-lg sm:text-xl md:text-[26px] lg:text-[30px] leading-normal mb-1">
        {title}
      </h3>
      ...
      <div className="max-w-[1000px] mx-auto">
        ...
        <ScrollReveal>
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <h2 className="font-playfair font-bold text-white text-xl sm:text-2xl md:text-3xl lg:text-[40px] leading-normal mb-4">
        ...
        <ScrollReveal delay={150}>
          <div className="p-5 sm:p-6 md:p-8 lg:p-12 text-center border-t border-b border-brand-gold/20">
            <h3 className="font-playfair font-bold text-white text-lg sm:text-xl md:text-2xl lg:text-[30px] leading-normal mb-4 sm:mb-6">
