          ...
          {articles.map((article, i) => (
            <ScrollReveal key={i} delay={i * 200} direction="right" distance="60px">
              ...
              >
                ...
                {/* Title */}
                <h3 className="font-playfair font-bold text-white text-lg sm:text-xl md:text-[22px] leading-[1.3] mb-2 group-hover:text-brand-gold transition-colors duration-300">
                  {article.title}
                </h3>
