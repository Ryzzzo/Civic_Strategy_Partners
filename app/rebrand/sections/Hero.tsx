...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center text-center max-w-[820px] px-6 sm:px-8 md:px-12 lg:px-16 pt-36 sm:pt-40 md:pt-44 lg:pt-48 pb-16 sm:pb-20 md:pb-28">
        ...
        >
          <h1
            className="font-playfair font-bold text-white text-3xl sm:text-4xl md:text-5xl lg:text-[58px] mb-6"
        ...
        >
          <p className="font-sans text-white/85 text-lg sm:text-xl md:text-[22px] leading-relaxed max-w-[640px] mx-auto mb-6">
        ...
        >
          <p className="font-sans text-white/75 text-base sm:text-lg leading-relaxed max-w-[620px] mx-auto mb-6">
        ...
        >
          <p className="font-playfair font-semibold text-brand-gold/90 text-lg sm:text-xl md:text-[22px] leading-relaxed max-w-[620px] mx-auto mb-8">
