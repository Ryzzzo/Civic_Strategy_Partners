      ...
      <div className="max-w-[720px] mx-auto">
        ...
        <ScrollReveal>
          <div className="text-center mb-10 sm:mb-12">
            ...
            <h2 className="font-playfair font-bold text-white text-xl sm:text-2xl md:text-3xl lg:text-[38px] leading-normal">
            ...
            {faqs.map((faq, i) => (
              ...
              >
                ...
                <div className="flex justify-between items-center py-4 sm:py-6 px-4 sm:px-6 md:px-8 min-h-[44px]">
                  <h3 className="font-playfair font-semibold text-white/90 text-base sm:text-[16px] md:text-[17px] pr-5 leading-normal">
                    {faq.q}
                  </h3>
                  <span
