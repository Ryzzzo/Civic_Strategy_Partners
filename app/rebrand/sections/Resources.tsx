      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <h2 className="font-playfair font-bold text-white text-3xl md:text-[38px] mb-2" style={{ lineHeight: 1.5 }}>
            ...
            <ScrollReveal key={i} delay={i * 200} scale={true}>
              ...
              >
                <div className="flex-1">
                  ...
                  <h4 className="font-playfair font-bold text-white text-[16px] md:text-[17px] mb-2" style={{ lineHeight: 1.5 }}>
                    {resource.title}
                  </h4>
