  ...
  return (
    ...
    >
      <div className="max-w-[800px] mx-auto">
        ...
        <div
          ref={formFade.ref}
          className={`mb-16 transition-all duration-1000 ease-[cubic-bezier(.22,1,.36,1)] ${
        ...
        <div
          ref={cardsFade.ref}
          className={`space-y-4 transition-all duration-1000 ease-[cubic-bezier(.22,1,.36,1)] ${
            cardsFade.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
        >
